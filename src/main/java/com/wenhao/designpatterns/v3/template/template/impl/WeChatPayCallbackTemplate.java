...
public class WeChatPayCallbackTemplate extends AbstractPayCallbackTemplate {
    ...
    protected String asyncService(Map<String, String> verifySignature) {
        log.info(">>>>>第三步 解析微信数据报文.....verifySignature:{}", verifySignature);
        String payMentStatus = verifySignature.get("wechatPayMentStatus");
        if ("1".equals(payMentStatus)) {
            String aliPayOrderNumber = verifySignature.get("wechatPayOrderNumber");
    ...
    protected Map<String, String> verifySignature() {
        log.info(">>>>>第一步 解析微信数据报文.....verifySignature()");
